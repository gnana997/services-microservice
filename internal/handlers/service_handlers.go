...
func (h *ServiceHandler) GetService(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusBadRequest, ErrorResponse{
			...
			Details: fmt.Sprintf("Provided ID: %s", c.Param("sid")),
		})
		return
	}
...
// @Accept json
// @Produce json
// @Param service body models.ServiceRequest true "Service details"
